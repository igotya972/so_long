...
#    Updated: 2023/08/03 09:10:24 by dams             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LINUX_MLX	=	-L/home/dferjul/Documents/42/so_long_dferjul/minilibx-linux -lmlx -lX11 -lXext
...
$(NAME) : $(OBJS) 
	$(CC) $(CFLAGS) $(OBJS) $(MAC_MLX) $(LINUX_MLX) -o $(NAME)
